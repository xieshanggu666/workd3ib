...
.timeline { background: #101d39; border: 1px solid rgba(120,160,220,0.15); border-radius: 10px; padding: 12px; }
.t-item { display: flex; align-items: baseline; gap: 8px; position: relative; padding: 4px 0 4px 10px; font-size: 12px; }
